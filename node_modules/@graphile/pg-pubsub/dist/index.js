...
const plugin = {
    ...
    ["cli:library:options"](options, { config, cliOptions }) {
        const { simpleSubscriptions = false, subscriptionAuthorizationFunction = null, } = Object.assign({}, config.options, cliOptions);
        return Object.assign({}, options, { simpleSubscriptions,
    ...
    ["postgraphile:options"](incomingOptions, { pgPool }) {
        ...
        const setupClient = async function (attempts = 0) {
            if (attempts > 9) {
                throw new Error("Attempted connection too many times, setupClient failed");
            }
        ...
        return Object.assign({}, incomingOptions, { graphileBuildOptions: Object.assign({}, incomingOptions.graphileBuildOptions, { pubsub, pgSubscriptionAuthorizationFunction: subscriptionAuthorizationFunction }), appendPlugins: [
