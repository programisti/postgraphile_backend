...
function makeProcField(fieldName, proc, build, {
  ...
  return fieldWithHooks(fieldName, ({
    ...
    function makeQuery(parsedResolveInfoFragment, ReturnType, sqlMutationQuery, functionAlias, parentQueryBuilder, resolveContext) {
    ...
    return {
      ...
      resolve: computed ? (data, _args, resolveContext, resolveInfo) => {
        ...
        let queryResultRows;
        if (isMutation) {
          const query = makeQuery(parsedResolveInfoFragment, resolveInfo.returnType, functionAlias, functionAlias, null, resolveContext);
          ...
          const query = makeQuery(parsedResolveInfoFragment, resolveInfo.returnType, sqlMutationQuery, functionAlias, null, resolveContext);
