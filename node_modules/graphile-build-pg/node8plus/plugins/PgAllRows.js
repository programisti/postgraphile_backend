...
exports.default = async function PgAllRows(builder, { pgViewUniqueKey, pgSimpleCollections, subscriptions }) {
        ...
        memo[fieldName] = fieldWithHooks(fieldName, ({ getDataFromParsedResolveInfoFragment }) => {
          return {
            ...
            async resolve(parent, args, resolveContext, resolveInfo) {
              ...
              if (subscriptions && resolveContext.liveCollection && checkerGenerator) {
              ...
              if (isConnection) {
                ...
                if (subscriptions && !isConnection && primaryKeys && resolveContext.liveRecord) {
                  result.rows.forEach(row => row && resolveContext.liveRecord("pg", table, row.__identifiers));
                }
                return result.rows;
              }
            }
