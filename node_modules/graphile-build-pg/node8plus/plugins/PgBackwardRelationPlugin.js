...
exports.default = function PgBackwardRelationPlugin(builder, { pgLegacyRelations, pgSimpleCollections, subscriptions }) {
          ...
          memo = extend(memo, {
            [manyRelationFieldName]: fieldWithHooks(manyRelationFieldName, ({
              ...
              return {
                ...
                resolve: (data, _args, resolveContext, resolveInfo) => {
                  const safeAlias = getSafeAliasFromResolveInfo(resolveInfo);
                  if (subscriptions && resolveContext.liveCollection && data.__live) {
                  ...
                  if (isConnection) {
                    ...
                    if (subscriptions && resolveContext.liveRecord) {
                      records.forEach(r => r && resolveContext.liveRecord("pg", table, r.__identifiers));
                    }
                    return records;
                  }
                },
