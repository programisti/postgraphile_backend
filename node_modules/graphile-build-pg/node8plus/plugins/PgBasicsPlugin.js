...
var _PgLiveProvider = require("../PgLiveProvider");

var _PgLiveProvider2 = _interopRequireDefault(_PgLiveProvider);
...
exports.default = function PgBasicsPlugin(builder, {
  ...
  builder.hook("build", build => {
    ...
    build.liveCoordinator.registerProvider(new _PgLiveProvider2.default());
