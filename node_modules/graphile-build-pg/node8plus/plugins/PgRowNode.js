...
exports.default = async function PgRowNode(builder, { subscriptions }) {
  builder.hook("GraphQLObjectType", (object, build, context) => {
    ...
    addNodeFetcherForTypeName(object.name, async (data, identifiers, resolveContext, parsedResolveInfoFragment, ReturnType, resolveData) => {
