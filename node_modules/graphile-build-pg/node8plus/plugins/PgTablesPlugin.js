...
exports.default = function PgTablesPlugin(builder, { pgForbidSetofFunctionsToReturnNull = false, subscriptions = false }) {
            ...
            return {
              ...
              node: pgField(build, fieldWithHooks, "node", {
                ...
                resolve(data, _args, resolveContext, resolveInfo) {
                  ...
                  if (record && primaryKeys && resolveContext.liveRecord && data.__identifiers) {
                    resolveContext.liveRecord("pg", table, data.__identifiers);
                  }
                  return record;
                }
              }, {}, false, {
              ...
              nodes: pgField(build, fieldWithHooks, "nodes", {
                ...
                resolve(data, _args, resolveContext, resolveInfo) {
                  ...
                  return data.data.map(entry => {
                    const record = handleNullRow(entry[safeAlias], entry.__identifiers);
                    if (record && resolveContext.liveRecord && primaryKeys && entry.__identifiers) {
                      resolveContext.liveRecord("pg", table, entry.__identifiers);
                    }
