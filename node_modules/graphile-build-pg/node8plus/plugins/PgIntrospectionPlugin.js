...
exports.default = async function PgIntrospectionPlugin(builder, {
  ...
  class Listener {
    constructor(triggerRebuild) {
      this.stopped = false;
      this._handleChange = (0, _throttle2.default)(async () => {
      ...
      try {
        ...
        if (this.stopped) {
          ...
          if (!pgSkipInstallingWatchFixtures) {
            ...
            await (0, _withPgClient2.default)(pgOwnerConnectionString || pgConfig, async pgClient => {
              try {
                ...
                if (!this._haveDisplayedError) {
                  ...
                  console.warn(_chalk2.default.yellow("This is likely because the PostgreSQL user in the connection string does not have sufficient privileges; you can solve this by passing the 'owner' connection string via '--owner-connection-string' / 'ownerConnectionString'. If the fixtures already exist, the watch functionality may still work."));
