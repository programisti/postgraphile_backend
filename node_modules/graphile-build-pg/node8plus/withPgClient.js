...
exports.getPgClientAndReleaserFromConfig = undefined;
...
const getPgClientAndReleaserFromConfig = exports.getPgClientAndReleaserFromConfig = async (pgConfig = process.env.DATABASE_URL) => {
  let releasePgClient = () => {};
  let pgClient;
...
const withPgClient = async (pgConfig, fn) => {
  ...
  const { pgClient, releasePgClient } = await getPgClientAndReleaserFromConfig(pgConfig);
