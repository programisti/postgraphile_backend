...
exports.default = (queryBuilderOptions = {}) => (from, fromAlias, resolveData, inOptions, withBuilder, context = {}, rootValue // eslint-disable-line flowtype/no-weak-types
) => {
  const {
    pgQuery,
    pgAggregateQuery,
  ...
  if (options.withPagination || options.withPaginationAsFields) {
    ...
    if (pgAggregateQuery && pgAggregateQuery.length) {
      const aggregateQueryBuilder = new _QueryBuilder2.default(
      // $FlowFixMe
      queryBuilderOptions, context, rootValue);
