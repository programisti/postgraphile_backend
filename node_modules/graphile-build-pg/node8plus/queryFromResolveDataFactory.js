...
exports.default = (queryBuilderOptions = {}) => (from, fromAlias, resolveData, options, withBuilder, context = {}) => {
  const {
    pgQuery,
    pgAggregateQuery,
  ...
  // $FlowFixMe
  const queryBuilder = new _QueryBuilder2.default(queryBuilderOptions, context);
  ...
  if (options.withPagination || options.withPaginationAsFields) {
    ...
    if (pgAggregateQuery && pgAggregateQuery.length) {
      const aggregateQueryBuilder = new _QueryBuilder2.default(queryBuilderOptions, context);
