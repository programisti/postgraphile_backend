...
function getFields(SelfGeneric, fields, resolvers, { fieldWithHooks, }, build) {
    ...
    function augmentResolver(resolver, fieldContext, type) {
        ...
        const recurseDataGeneratorsWorkaroundField = recurseDataGeneratorsWorkaroundFieldByType.get(namedType);
    ...
    if (fields && fields.length) {
        return fields.reduce((memo, field) => {
            if (field.kind === "FieldDefinition") {
                ...
                const scope = Object.assign({ fieldDirectives: directives }, (directives.scope || {}));
